...
function Collection() {
    return (
        ...
        <section id="collection" className="py-5 site-color">
            <div className="container">
                <div className="title text-center">
                    <h1 className="position-relative d-inline-block">Products</h1>
                </div>
                    ...
                    <div className="collection-list mt-4 row gx-0 gy-3">
                        <div className="col-md-6 col-lg-4 col-xl-3 p-2 best">
                            ...
                            <div className="text-center">
                                ...
                                <p className="text-capitalize my-1">Ray-Ban Sunglasses</p>
                        ...
                        <div className="col-md-6 col-lg-4 col-xl-3 p-2 new">
                            ...
                            <div className="text-center">
                                ...
                                <p className="text-capitalize my-1">Vision Glasses</p>
                                <span className="fw-bold">Block Token</span>
                            </div>
                        </div>
                        ...
                        <div className="col-md-6 col-lg-4 col-xl-3 p-2 best">
                            ...
                            <div className="text-center">
                                ...
                                <p className="text-capitalize my-1">Pierre Cardin Sunglasses</p>
                                <span className="fw-bold">Block Token</span>
                            </div>
                        </div>
                        ...
                        <div className="col-md-6 col-lg-4 col-xl-3 p-2 feat">
                            ...
                            <div className="text-center">
                                ...
                                <p className="text-capitalize my-1">Guerlain Perfume</p>
                                <span className="fw-bold">Block Token </span>
                            </div>
                        </div>
                        ...
                        <div className="col-md-6 col-lg-4 col-xl-3 p-2 new">
                            ...
                            <div className="text-center">
                                ...
                                <p className="text-capitalize my-1">Gucci Perfume</p>
                                <span className="fw-bold">Block Token </span>
                            </div>
                        </div>
                        ...
                        <div className="col-md-6 col-lg-4 col-xl-3 p-2 best">
                            ...
                            <div className="text-center">
                                ...
                                <p className="text-capitalize my-1">Pierre Cardin Glasses</p>
                                <span className="fw-bold">Block Token</span>
                            </div>
                        </div>
                        ...
                        <div className="col-md-6 col-lg-4 col-xl-3 p-2 feat">
                            ...
                            <div className="text-center">
                                ...
                                <p className="text-capitalize my-1">Wiseman Paris Perfume</p>
                                <span className="fw-bold">Block Token</span>
                            </div>
                        </div>
                    </div>
